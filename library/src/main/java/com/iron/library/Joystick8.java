...
public class Joystick8 extends View {
    ...
    public Joystick8(Context context) {
        super(context);
        initJoystick8();
    }

    public Joystick8(Context context, AttributeSet attrs) {
        super(context, attrs);
        initJoystick8();
    }

    public Joystick8(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initJoystick8() {
        ...
        setUserCoordinateSystem(COORDINATE_DIFFERENTIAL);
...
//				Log.d(TAG, "click");
    ...
    public static interface JoystickMovedListener {
        public void OnMoved(int pan, int tilt);
        public void OnReleased();
        public void OnReturnedToCenter();
    }

    public static interface JoystickClickedListener {
